...
void runTest(){
    ...
    startLamp(lamp1); delay(1000);
    startLamp(lamp2); delay(1000);
    startLamp(lamp3); delay(1000);
    startLamp(lamp4); delay(1000);

    delay(3000);

    stopLamp(lamp1); delay(1000);
    stopLamp(lamp2); delay(1000);
    stopLamp(lamp3); delay(1000);
    stopLamp(lamp4); delay(1000);
}
